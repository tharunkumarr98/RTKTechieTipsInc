...
dataset_name = 'Stock market Global Version' #Enter the import/DQ semantic model name
workspace_name = 'Direct lake Migration' #Enter the workspace of the import/DQ semantic model. It set to none it will use the current workspace.
new_dataset_name = 'Stock market Global Version Direct Lake' #Enter the new Direct Lake semantic model name
new_dataset_workspace_name = "Direct lake Migration" #Enter the workspace where the Direct Lake model will be created. If set to None it will use the current workspace.
lakehouse_name = "ExtractStockMarketData" #Enter the lakehouse to be used for the Direct Lake model. If set to None it will use the lakehouse attached to the notebook.
lakehouse_workspace_name = "Direct lake Migration" #Enter the lakehouse workspace. If set to None it will use the new_dataset_workspace_name.
